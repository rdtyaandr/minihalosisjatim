	...
	<div class="row">
		<div class="col-md-12">
			<div class="row px-1">
				...
				<!--								<h1 class="mb-0">--><?php //echo $stats['recent'] ? $stats['recent'] : '0.0'; 
																		?><!--</h1>-->
		...
		<div class="col-xl-4">
			<div class="row">
				...
				<ul>
					...
					<li><a href="<?= site_url('admin/list'); ?>">Daftar</a></li>
					<li><a href="<?= site_url('admin/manage'); ?>">Kelola</a></li>
					<li><a href="<?= site_url('admin/jenis'); ?>">Jenis</a></li>
					<li><a href="<?= site_url('admin/lokasi'); ?>">Lokasi</a></li>
				</ul>
