                    ...
                    <div class="navbar-holder d-flex align-items-center justify-content-between">
                        ...
                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle sidebar-header d-flex align-items-center" href="#" id="navbarDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="page-content d-flex align-items-stretch">
            ...
            <div class="content-inner">
                <div class="alert alert-warning alert-dismissible fade show" role="alert" style="margin-bottom: 0rem">
                    <p>
                        <strong>Hey!</strong> You can automatically create a ticket by sending an email to ipds3500@bps.go.id. (email feature still disabled)
                    ...
                    <p class="mb-0">Note: Berikut adalah laman ujicoba Minihalosis BPS Jawa Timur</p>
                </div>
                <!-- Page Header-->
