...
<li><a href="<?= BASE_URL ?>listcontrol/list" class="nav-link"><i class="bi bi-list-nested"></i>List </a></li>

<li><a href="#ManagesDropdown" aria-expanded="false" data-toggle="collapse"><i class="bi bi-gear"></i>Manage </a>
