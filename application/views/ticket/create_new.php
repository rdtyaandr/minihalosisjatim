                                ...
                                <form>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <input id="purpose" type="text" name="purpose" required="" class="form-control" placeholder="Purpose of the ticket">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-8">
                                            <input type="submit" id="create_ticket" value="Add" class="btn btn-success pull-right">
                                        </div>
                                    </div>
                                </form>
                            </div>
