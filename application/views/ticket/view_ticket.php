                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><a href="Javascript:void(0);" class="edit-ticket-dropdown">Edit</a>
                                        <div class="col-sm-12 select select-ticket-dropdown hide" style="position: absolute;right:0; margin-top: -25px;">
                                            <select name="status" id="status_dd" data-id="<?= $info['id'] ?>" data-type="4" class="form-control" style="width: 100%">
                                                <option></option>
                                            </select>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="Javascript:void(0);" class="edit-ticket-dropdown">Edit</a>
                                        <div class="col-sm-12 select select-ticket-dropdown hide" style="position: absolute;right:0; margin-top: -25px;">
                                            <select name="severity" id="severity_dd" data-id="<?= $info['id'] ?>" data-type="5" class="form-control selection" style="width: 100%">
                                                <option></option>
                                            </select>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><span class="tik-category" data-value="<?= isset($info['category']) ? $info['category'] : '-' ?>"></span>
                                    </td>
                                    <td><a href="Javascript:void(0);" class="edit-ticket-dropdown">Edit</a>
                                        <div class="col-sm-12 select select-ticket-dropdown hide" style="position: absolute;right:0; margin-top: -25px;">
                                            <select name="category" id="category_dd" data-id="<?= $info['id'] ?>" data-type="7" class="form-control" style="width: 100%">
                                                <option></option>
                                            </select>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    if ($privilege) { ?>
                                        <td><a href="Javascript:void(0);" class="edit-ticket-dropdown">Edit</a>
                                            <div class="col-sm-12 select select-ticket-dropdown hide" style="position: absolute;right:0; margin-top: -25px;">
                                                <select name="priority" id="priority_dd" data-id="<?= $info['id'] ?>" data-type="6" class="form-control " style="width: 100%">
                                                    <option></option>
                                                </select>
                                            </div>
                                        </td>
                                ...
                                <tr>
                                    <th>Assigned to</th>
                                    <td><span class="user-label" data-username="<?= isset($info['assign_to']) ? $info['assign_to'] : '' ?>"></span>
                                    </td>
                                    <?php
                                    if ($privilege) { ?>
                                        <td><a href="Javascript:void(0);" class="edit-ticket-dropdown">Edit</a>
                                            <div class="col-sm-12 select select-ticket-dropdown hide" style="position: absolute;right:0; margin-top: -25px;">
                                                <select name="assign_to" id="assign_to_dd" data-id="<?= $info['id'] ?>" data-type="8" class="form-control" style="width: 100%">
                                                    <option></option>
                                                </select>
                                            </div>
                                        </td>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (JSON.parse(response)['data']['result']) {
                        ...
                        showNotification('success', 'Comment added successfully', {}, function() {
                            window.location.reload();
                        })
                    } else
