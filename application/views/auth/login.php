                ...
                <div class="col-lg-6 bg-white">
                    <div class="form d-flex align-items-center">
                        <div class="content">
                            ...
                            <button type="button" id="login" href="" class="btn btn-primary">Login SSO</button>
                            <div>
                                <?= get_msg(); ?>
                            </div>
                            <a href="forgot_password" class="forgot-pass">Forgot Password?</a><br><small>Do not have an account? </small><a href="register" class="signup">Signup</a>
                        </div>
