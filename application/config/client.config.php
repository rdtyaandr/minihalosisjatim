...
//Root Url of ur site
define('BASE_URL', 'http://localhost/minihalosisjatim/');

define('PAGE_LOADER', BASE_URL . 'assets/img/loading.webp');

//Client Specific site wide information
define('CLIENT_FNAME', 'MiniHalosis');
define('CLIENT_MNAME', 'Halosis Mini BPS Jawa Timur');
define('CLIENT_FULL_NAME', 'BPS Provinsi Jawa Timur');
define('CLIENT_ADDRESS', 'Surabaya, Jawa Timur');
...
define('CLIENT_TICKET_PREFIX', 'JATIM-');
define('CLIENT_TICKET_ID_LENGTH', 6);

//Client Mail Settings
define('CLIENT_FROM_EMAIL', 'ipds3500@bps.go.id');
define('CLIENT_HELPDESK_EMAIL', 'ipds3500@bps.go.id');
define('CLIENT_REPLYTO_EMAIL', 'ipds3500@bps.go.id');
define('CLIENT_SMTP_CONFIG', array(
	'protocol' => 'smtp',
	'smtp_host' => 'ssl://smtp.bps.go.id',
	//'smtp_port' => 587,
	'smtp_port' => 465,
	'smtp_user' => 'ipds3500@bps.go.id',
	'smtp_pass' => 'jatimsukses',
	'charset'   => 'iso-8859-1',
	'clrf' => '\r\n',
	'newline' => '\r\n'
));
