...
define('DEV_COMPANY_NAME', 'Minihalosis BPS Jawa Timur');
define('DEV_COMPANY_EMAIL', 'ipds3500@bps.go.id');
define('DEV_COMPANY_PHONE', '081234567X');
define('DEV_COMPANY_SUPPORT_EMAIL', 'ipds3500@bps.go.id');
define('DEV_COMPANY_URL', 'http://jatim.bps.go.id');
define('DEV_COMPANY_LOGO', 'assets/img/logo.png');

/**
 * Product related information
 */
define('PRODUCT_NAME', 'Minihalosis BPS Jawa Timur');
