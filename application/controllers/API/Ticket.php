...
class Ticket extends MY_Controller
{
    ...
    public function addThreadMessage()
    {
        ...
        if (trim($thread_data['message']) == '') {
            ...
            $lenattachment = !isset($this->input->post('data')['attachments']) ? 0 : $this->input->post('data')['attachments'];
            $this->Tickets->addAttachmentRef($lenattachment,  $this->input->post('ticket_no'));
    ...
    public function sendEmail()
    {
        ...
        print_r($this->Email->send('ipds3500@bps.go.id', '', 'Hello', 'Hello', ''));
    }
